...
CPUMINER_ADDRESS="--coinbase-addr=RcUvFwpKnXsCpHFWwsB8Btqn3u78wj7MYE"
...
ATTACK_INTERVAL=1020 # 2*5 = 10 =~ 10 seconds
ATTACK_PROGRAM_AMOUNT=8 # 1-2-3-4-5-6-7-8
